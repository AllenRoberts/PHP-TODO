...
<body>
    <div>
        <!--Form that takes in task info from the user-->
        <form class="new-task" action="save.php" method="post">
            ...
            <!--Checks if there is a selected task and changes text on button accordingly -->
            <button><?php
                    if ($currentTask['id']) :
                    ?>
                    Update Task
        ...
        <div class="tasks">
            <!--Iterates through tasks retrieved from database and displays them-->
